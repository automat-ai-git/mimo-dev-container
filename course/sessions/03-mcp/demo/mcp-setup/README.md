...
Подключаем три MCP-сервера к MiMo-Code: Google Drive, Tavily (поиск в интернете) и Filesystem. После настройки Claude сможет искать документы в облаке, находить информацию в вебе и работать с файлами в указанных папках.
...
- Claude предложит добавить конфиг в `.mimocode/settings.json`
